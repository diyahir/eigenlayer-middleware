...
abstract contract ServiceManagerBase is IServiceManager, OwnableUpgradeable {
    ...
    IRoleManager internal immutable _roleManager;
    ...
    modifier onlyPaymentCoordinator() {
        require(
            _roleManager.isPaymentCoordinator(msg.sender),
