...
import {SafetyFactorUpdaterLib} from "./libraries/SafetyFactor.sol";
...
contract AVSReservesManager is IAVSReservesManager, AccessControl {
    ...
    using SafetyFactorUpdaterLib for SafetyFactorUpdater;

    bytes32 public constant ANZEN_GOV_ROLE = keccak256("ANZEN_GOV_ROLE");

    // Mapping of avs service manager addresses to Safety Factor Updaters
    mapping(address => SafetyFactorUpdater) public safetyFactorUpdaters;
    ...
    IServiceManager public paymentMaster; // Address of the Payment Master contract
    ...
    function setPaymentMaster(address _paymentMaster) external {
        ...
        paymentMaster = IServiceManager(_paymentMaster);
    }
